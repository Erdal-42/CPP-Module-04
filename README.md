In this module I had to demonstrate subtype polymorphism, abstract classes and interfaces in C++98 OOP. I had to structure my files as header files and source files.  
